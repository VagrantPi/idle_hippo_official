...
This privacy policy page was generated by <a href="https://app-privacy-policy-generator.firebaseapp.com/" target="_blank" rel="noopener noreferrer">App Privacy Policy Generator</a>.`,
    },
  },
  zh: {
    nav: {
...
此隱私權政策頁面由<a href="https://app-privacy-policy-generator.firebaseapp.com/" target="_blank" rel="noopener noreferrer">應用程式隱私權政策產生器</a>產生。`,
    },
  },
  jp: {
    nav: {
...
このプライバシーポリシーページは、<a href="https://app-privacy-policy-generator.firebaseapp.com/" target="_blank" rel="noopener noreferrer">アプリプライバシーポリシージェネレーター</a>によって生成されました。`,
    },
  },
  ko: {
    nav: {
...
이 개인정보처리방침 페이지는 앱 <a href="https://app-privacy-policy-generator.firebaseapp.com/" target="_blank" rel="noopener noreferrer">개인정보처리방침 생성기</a>에 의해 생성되었습니다.`,
    },
  },
}
